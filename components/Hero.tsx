    ...
    >
      ...
      >
        <Stack maxW={"2xl"} align={"flex-end"} spacing={6}>
          ...
          <Text
          width={useBreakpointValue({base: '100%', sm: '72%'})}
            align={"right"} color={"whiteAlpha.700"}>
            Идеальный подарок для знакомых и родных. Красочный узор на
            приятнейшем материале. Тепло не только ногам, но и душе - ничего больше
          </Text>
          <Stack direction={"row"}>
            <Button
              bg={"blue.400"}
